...
DEFAULT_PLANE = "axial"
defaultcase_id = 0
defaultdestination = "path/to/save/images"
...
def visualize(cid=defaultcase_id, destination0=defaultdestination, hu_min=DEFAULT_HU_MIN, hu_max=DEFAULT_HU_MAX, 
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "-c", "--case_id", required=False, default=defaultcase_id,
        help="The identifier for the case you would like to visualize"
    )
    parser.add_argument(
        "-d", "--destinationgr", required=False, default=defaultdestination,
    ...
    # Run visualization
    visualize(
        cid=args.case_id, destination0=args.destinationgr,
        hu_min=args.lower_hu_bound, hu_max=args.upper_hu_bound,
        plane=args.plane
    )
#        defaultcase_id=args.case_id, defaultdestination=args.destination, 
#get_data